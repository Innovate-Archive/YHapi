...
function yh_CreateAccount($params) {
...
function yh_TerminateAccount($params) {
...
function yh_SuspendAccount($params) {
...
function yh_UnsuspendAccount($params) {
...
function yh_ChangePassword($params) {
...
function yh_ChangePackage($params) {
...
function yh_ClientArea($params) {

    # Output can be returned like this, or defined via a clientarea.tpl yh file (see docs for more info)
...
function yh_ClientAreaCustomButtonArray() {
    $buttonarray = array(
...
function yh_AdminCustomButtonArray() {
    $buttonarray = array(
	 "Reboot Server" => "reboot",
...
function yh_UsageUpdate($params) {
...
function yh_AdminServicesTabFields($params) {
...
function yh_AdminServicesTabFieldsSave($params) {
